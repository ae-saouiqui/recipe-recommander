...
class Recommandation :
    def __init__(self,vectors_path="/home/aes-saouiqui/spark-project/backend/vectorized_df.parquet",vectorizer_path="/home/aes-saouiqui/spark-project/backend/vectorizer",model_path=None):
        conf = SparkConf()\
    ...
    .getOrCreate()
        ...
        self.recommander = Recommander(self.spark,vectors_path,vectorizer_path,model_path)
